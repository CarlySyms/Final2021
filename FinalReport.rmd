...
$H_O$ the null hypothesis given taking the vaccine there is a big difference of whether or not a female can contracts Covid.  
$H_A$ the alternative hypothesis is that the vaccine doesn't make a difference in whether or not a female can contract Covid. Therefor we agree with the Null hypothesis.   
The odds ratio in the fisher exact test is 0.49:1, when taking the odds ratio and computing it into a percent of effectiveness by using the formula 0/(1+0)*100 you get 34% effectiveness.
